...
Creates child and parent health models. The parent embeds the child model ID as an ordinary Azure-resource entity with no inline signals. No caller inputs are required.
...
### <a name="module_child"></a> [child](#module\_child)

Source: ../..

Version:

### <a name="module_parent"></a> [parent](#module\_parent)
