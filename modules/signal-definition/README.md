...
# Signal definition submodule

> **Preview:** This submodule manages `Microsoft.CloudHealth/healthmodels/signaldefinitions@2026-05-01-preview`.

Creates one reusable Azure metric, PromQL, or KQL signal definition.
...
### <a name="input_evaluation_rules"></a> [evaluation\_rules](#input\_evaluation\_rules)
...
### <a name="input_signal_kind"></a> [signal\_kind](#input\_signal\_kind)
...
### <a name="input_aggregation_type"></a> [aggregation\_type](#input\_aggregation\_type)
...
### <a name="input_data_unit"></a> [data\_unit](#input\_data\_unit)
...
### <a name="input_dimension_filter"></a> [dimension\_filter](#input\_dimension\_filter)
...
### <a name="input_metric_name"></a> [metric\_name](#input\_metric\_name)
...
### <a name="input_query_text"></a> [query\_text](#input\_query\_text)
...
### <a name="input_refresh_interval"></a> [refresh\_interval](#input\_refresh\_interval)
...
### <a name="input_value_column_name"></a> [value\_column\_name](#input\_value\_column\_name)
